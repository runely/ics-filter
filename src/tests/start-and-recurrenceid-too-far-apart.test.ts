...
const content: string = readFileSync("./ics/start-and-recurrenceid-too-far-apart.ics", "utf-8");
...
describe("icsFilter on ics content with start and recurrenceId too far apart with no max limit", () => {
...
describe("icsFilter on ics content with start and recurrenceId too far apart with max limit", () => {
  test("should always return ics content with a 'BEGIN:VCALENDAR' and a 'END:VCALENDAR'", () => {
